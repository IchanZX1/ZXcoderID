...
export async function participantsUpdate({ id, participants, action }) {
 ...
 /* conn.sendButtonDoc(id, wm, text, action == 'add' ? 'ᴡᴇʟᴄᴏᴍᴇ' : 'sᴀʏᴏɴᴀʀᴀᴀ', action === 'add' ? '.intro' : 'Aʟᴅɪ X Aɪsʏᴀʜ', fkontak, { contextInfo: { externalAdReply: { showAdAttribution: true,
  ...
  let welcom = 'https://telegra.ph/file/9a391cc2c3e65bdbbb948.jpg'

  let godbye = 'https://telegra.ph/file/f9bc08c33b277b2291d82.jpg'
  conn.sendButtonImg(id, await(await fetch(action === 'add' ? wel : lea)).buffer(), 'Group Messege', text, action == 'add' ? 'ᴡᴇʟᴄᴏᴍᴇ | 𝐓𝐨 𝐌𝐲 𝐆𝐫𝐨𝐮𝐩' : 'sᴀʏᴏɴᴀʀᴀᴀ', action === 'add' ? '.intro' : 'Aʟᴅɪ X Aɪsʏᴀʜ', fkontak, { contextInfo: { externalAdReply: { showAdAttribution: true,
    mediaUrl: 'https://m.youtube.com/channel/UCBdvBm2NuvFaqwDIcu48A4A',
    mediaType: 2, 
    description: sgc,
    title: "sᴜʙsᴄʀɪʙᴇ ɪᴄʜᴀɴ ɢᴀᴍɪɴɢ",
    body: wm,
