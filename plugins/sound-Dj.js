...
ptt: false, seconds: 0,contextInfo: {
 ...
 mediaUrl: 'www.instagram.com/_fake.story46',
    mediaType: 2, 
    description: 'www.instagram.com/hyuura-official',
    title: "Now Playing...",
    body: wm,
    thumbnail: await (await fetch('https://telegra.ph/file/e6f7ec21f6a26bee02f81.jpg')).buffer(),
    sourceUrl: 'www.instagram.com/_fake.story46'
 	  /*   sourceUrl: sig,
           title: '◄⟬ ●━━━ ⧏ ⧎ ⧐ ━━━● ⟭►',  
            body: 'Now Playing...', 
